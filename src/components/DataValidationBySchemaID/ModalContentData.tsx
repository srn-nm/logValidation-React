...
import ModalDataTableNonCalc from "./ModalDataTableNonCalc";
import ModalSummaryCardsData from "./ModalSummaryCardsData";

export default function ModalContentData ({validationResponse}: {validationResponse: DataValidationResponse}) {
    return (
        <>
             <div className="p-6 overflow-auto w-full">
                <div className="space-y-6">

                  <ModalSummaryCardsData validationResponse={validationResponse}/>

                  <ModalDataTableNonCalc validationResponse={validationResponse}/>
